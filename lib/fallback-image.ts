// Fallback image for Venorus.net (broken image icon)
export const PROSTHETIC_FALLBACK_IMAGE = `data:image/svg+xml;base64,${Buffer.from(String.raw`
  <svg xmlns="http://www.w3.org/2000/svg" width="400" height="300" viewBox="0 0 400 300" role="img" aria-labelledby="title desc">
    <title>Venorus.net — изображение недоступно</title>
    <desc>Логотип Venorus.net и иконка сломанного изображения как заполнитель.</desc>
    ...
    <!-- Лёгкий декор -->
    <g opacity="0.16" fill="#3b82f6">
      <circle cx="60" cy="60" r="44"/>
    </g>
    <g opacity="0.10" fill="#6366f1">
    ...
    <g transform="translate(200 120)" filter="url(#iconShadow)">
      ...
      <g clip-path="url(#clipHole)">
        ...
        <path d="M-58 24 L-30 -5 L-8 10 L18 -18 L40 4 L58 -12" fill="none" stroke="#1e40af" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" opacity=".55"/>
        <!-- "Горы" -->
